...
ent-UniformPrisonDoctorMetus = комбинезон тюремного доктора
    .desc = Ткань местами выгорела и потемнела, на рукавах пятна от лекарственных жидкостей, материал будто впитал тяжёлые операции.
ent-UniformPrisonChefMetus = комбинезон тюремного повара
    .desc = Ткань пропитана жиром и копотью, на рукавах пятна от постоянного контакта с плитой и кастрюлями, слегка вытертые в местах, где привычка к порядку сильнее усталости.
ent-UniformPrisonEngineerMetus = комбинезон тюремного инженера
    .desc = Материал плотный и слегка вытертый на локтях и коленях, на ткани тёмные пятна неизвестного происхождения, будто впитал запахи заброшенных мест тюрьмы.
ent-UniformPrisonScientistMetus = комбинезон тюремного учёного
    .desc = По плечам и груди тёмные разводы от реагентов, мелкие пятна химических смесей, ткань будто хранит память об экспериментах, о которых лучше молчать.
ent-UniformPrisonWorkerMetus = комбинезон тюремного разнорабочего
    .desc = Ткань изранена рудной пылью и мелкими царапинами, локти и колени слегка вытерты, пахнет металлом и сыростью шахт, словно хранит встречи с неизвестным.
